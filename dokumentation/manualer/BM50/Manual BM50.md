...
Sedan ställer du termostaten ungefär på den temperatur du vill ha för inmäskning. Termostaten är mekanisk och bestämmer den temperatur där elementen kopplas ifrån helt. Den är inte särskilt exakt och skalan är både oprecis och felställd så man behöver stämma av mot termometern innan man går till bryggning. När man värmer bryggvattnet är det en bra ide att cirkulera vätskan med pumpen eftersom det gör värmningen mer effektiv.
...
![De delar som används när maltpipan monteras i bryggverket.](img/insats.png)
